import type { Card, Rank, HandEvaluation, HandRank, GameState, PlayerState, PlayerAction } from "@/types/poker"
...
export function initializeGame(playerIds: string[], playerNames: string[], startingChips = 1000): GameState {
  deckManager.reset()
